...
<body class="">
    ...
    <div class="p-4" style="background-color: #d35400">
        ...
        <div class="col-md-12 text-center">
            <button class="btn btn-coklat col-md-6 mb-4 p-3 text-white btn-rounded" style="border-radius: 18px;font-size:18px">Kembali lagi besok untuk mendapat <b style="font-size:20px">5 poin</b></button>
        </div>
    </div>
