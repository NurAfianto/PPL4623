...
<div class="bg-hutan">
    ...
    <div class="">
        ...
        <div class="text-air-terisi">
            <img src="<?=base_url('assets/pict/Icon/water-drop.png')?>" alt="" srcset="" width="30">
            <span id="angka-air"><?=$kekurangan==null?'300':$kekurangan?></span>
        </div>
    </div>
    <button class="btn btn-siram" onclick="siram()">
        <img src="<?=base_url('assets/pict/Icon/icon-siram.png')?>" alt="" srcset="" class="img-siram" width="120px">
        <div class="text-angka" style="right:60px;bottom:15px;">
            10
        </div>
    </button>
